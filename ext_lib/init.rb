...
# Routing Extension
require File.join(File.dirname(__FILE__), 'user_system_has_accounts_routing_extension')
ActionController::Routing::RouteSet.send :include, UserSystemHasAccountsRoutingExtension
